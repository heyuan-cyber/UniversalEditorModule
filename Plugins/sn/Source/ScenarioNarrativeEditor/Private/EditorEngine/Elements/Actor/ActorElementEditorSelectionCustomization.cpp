...
DEFINE_LOG_CATEGORY_STATIC(LogActorEditorSelection, Log, All);

bool FActorElementEditorSelectionCustomization::CanSelectElement(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, const FTypedElementSelectionOptions& InSelectionOptions)
{
    return CanSelectActorElement(InElementSelectionHandle, InSelectionOptions);
}

bool FActorElementEditorSelectionCustomization::CanDeselectElement(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, const FTypedElementSelectionOptions& InSelectionOptions)
{
    return CanDeselectActorElement(InElementSelectionHandle, InSelectionOptions);
}

bool FActorElementEditorSelectionCustomization::SelectElement(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions)
{
    return SelectActorElement(InElementSelectionHandle, InSelectionSet, InSelectionOptions);
}

bool FActorElementEditorSelectionCustomization::DeselectElement(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions)
{
    return DeselectActorElement(InElementSelectionHandle, InSelectionSet, InSelectionOptions);
}

bool FActorElementEditorSelectionCustomization::AllowSelectionModifiers(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, FTypedElementListConstRef InSelectionSet)
{
...
FTypedElementHandle FActorElementEditorSelectionCustomization::GetSelectionElement(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, FTypedElementListConstRef InCurrentSelection, const ETypedElementSelectionMethod InSelectionMethod)
{
...
void FActorElementEditorSelectionCustomization::GetNormalizedElements(const TTypedElement<ITypedElementSelectionInterface>& InElementSelectionHandle, FTypedElementListConstRef InSelectionSet, const FTypedElementSelectionNormalizationOptions& InNormalizationOptions, FTypedElementListRef OutNormalizedElements)
{
    ...
    FActorElementEditorSelectionCustomization::AppendNormalizedActors(Actor, InSelectionSet, InNormalizationOptions, OutNormalizedElements);
}

namespace EditorSelectionHelpers
{
...
bool IsActorReachable(const AActor* Actor)
{
    ...
    {
        UE_LOG(LogActorEditorSelection, Warning, TEXT("SelectActor: %s (%s) Flags: (0x%08X)"),
...
bool FActorElementEditorSelectionCustomization::CanSelectActorElement(const TTypedElement<ITypedElementSelectionInterface>& InActorSelectionHandle, const FTypedElementSelectionOptions& InSelectionOptions) const
{
    ...
    if (!EditorSelectionHelpers::IsActorReachable(Actor))
    {
        return false;
    }
    ...
    {
        UE_CLOG(InSelectionOptions.WarnIfLocked(), LogActorEditorSelection, Warning, TEXT("SelectActor: %s (%s)"), TEXT("The requested operation could not be completed because the level is locked."), *Actor->GetActorLabel());
        return false;
    }
...
bool FActorElementEditorSelectionCustomization::CanDeselectActorElement(const TTypedElement<ITypedElementSelectionInterface>& InActorSelectionHandle, const FTypedElementSelectionOptions& InSelectionOptions) const
{
    AActor* Actor = ActorElementDataUtil::GetActorFromHandleChecked(InActorSelectionHandle);
...
bool FActorElementEditorSelectionCustomization::SelectActorElement(const TTypedElement<ITypedElementSelectionInterface>& InActorSelectionHandle, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions)
{
    AActor* Actor = ActorElementDataUtil::GetActorFromHandleChecked(InActorSelectionHandle);
    ...
    UE_LOG(LogActorEditorSelection, Verbose, TEXT("Selected Actor: %s (%s)"), *Actor->GetActorLabel(), *Actor->GetClass()->GetName());
...
bool FActorElementEditorSelectionCustomization::DeselectActorElement(const TTypedElement<ITypedElementSelectionInterface>& InActorSelectionHandle, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions)
{
    AActor* Actor = ActorElementDataUtil::GetActorFromHandleChecked(InActorSelectionHandle);
    ...
    UE_LOG(LogActorEditorSelection, Verbose, TEXT("Deselected Actor: %s (%s)"), *Actor->GetActorLabel(), *Actor->GetClass()->GetName());
...
bool FActorElementEditorSelectionCustomization::SelectActorGroup(AGroupActor* InGroupActor, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions, const bool bForce)
{
    bool bSelectionChanged = false;
...
bool FActorElementEditorSelectionCustomization::DeselectActorGroup(AGroupActor* InGroupActor, FTypedElementListRef InSelectionSet, const FTypedElementSelectionOptions& InSelectionOptions, const bool bForce)
{
    bool bSelectionChanged = false;
...
void FActorElementEditorSelectionCustomization::AppendNormalizedActors(AActor* InActor, FTypedElementListConstRef InSelectionSet, const FTypedElementSelectionNormalizationOptions& InNormalizationOptions, FTypedElementListRef OutNormalizedElements)
{
